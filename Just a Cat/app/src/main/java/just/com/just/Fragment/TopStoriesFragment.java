...
import just.com.just.Adapter.NewsRecyclerAdapter;
import just.com.just.Bean.News;
import just.com.just.Loader.NewsLoader;
import just.com.just.R;

public class TopStoriesFragment extends Fragment implements LoaderCallbacks<List<News>>
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (getArguments() != null) newsCategory = getArguments().getString(NEWS_CATEGORY);
	}
	...
	public void onLoadFinished(Loader<List<News>> loader, List<News> news)
	{
		...
		if (news != null && !news.isEmpty()) adapter.addAll(news);
	}
