...
import just.com.just.Gson.Forecast;
import just.com.just.Gson.Weather;
import just.com.just.Http.HttpUtil;
import just.com.just.Http.Utility;
import just.com.just.R;
import just.com.just.Service.AutoUpdateService;
...
public class WeatherActivity2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        swipeRefresh = (SwipeRefreshLayout) findViewById(R.id.swip_refresh_weather);
    ...
    {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=a42b670bf5e6410191702e130f5c9198";
            ...
            public void onResponse(Call call, Response response) throws IOException
            {
                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        else Toast.makeText(WeatherActivity2.this, "获取天气信息失败", Toast.LENGTH_SHORT).show();
