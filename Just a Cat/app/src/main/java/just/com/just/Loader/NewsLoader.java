...
import just.com.just.util.NewsQueryUtils;
...
public class NewsLoader extends AsyncTaskLoader<List<News>>
{
	...
	{
		if (mData != null) deliverResult(mData); // Serve cache data
		else forceLoad(); // Data does not exist
	}
