...
import just.com.just.Activity.MainActivity;
...
import static just.com.just.Activity.MainActivity.getList;
import static just.com.just.Activity.MainActivity.id;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>
{
    ...
    public StoryAdapter(List<Story> storyList)
    {
        if (count == 0)
        {
            ...
            {
                for (int i = page; i < storyList.size(); i++) mStoryList.remove(i);
            }
        }
        else
        {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                else
                {
                    ...
                    else Toasty.info(view.getContext(), "No more", Toast.LENGTH_SHORT,true).show();
                }
            }
        });
        return holder;
    ...
    public void onBindViewHolder(ViewHolder holder, int position)
    {
        ...
        else
        {
            ...
            {
                holder.storyName.setText("你到达的知识的荒原");
    ...
    public int getItemCount()
    {
        if (count == 0)
        {
            if (page > mStoryList.size()) return mStoryList.size() + 1;
            else return page + 1;
        }
        else return mStoryList.size() + 1;
    }
}
