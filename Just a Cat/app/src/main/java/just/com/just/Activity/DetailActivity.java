            ...
            fab.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    else
                    {
                        ...
                        Snackbar.make(view, "收藏成功！", Snackbar.LENGTH_LONG).setAction("确定", new View.OnClickListener()
                        {
                            @Override
                            public void onClick(View view)
                            {
            ...
            fab.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    else
                    {
                        ...
                        //收藏
                        dbHelper.deleteByName(intent.getStringExtra("title"));
                        Snackbar.make(view, "取消成功！", Snackbar.LENGTH_LONG).setAction("确定", new View.OnClickListener()
                        {
                            @Override
                            public void onClick(View view)
                            {
